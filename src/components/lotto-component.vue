<template>
  <div class="lotto">
    <h3><b-badge variant="danger">買了不一定會中哦</b-badge></h3>
    ...
    <div class="event" v-if="winEvent">
      ...
      <h5 v-if="winEvent._status" id="has-won"><b-badge variant="success"><i aria-hidden="true" class="fa fa-check"></i> 大吉大利, 你贏得 {{winEvent._amount}} Eth</b-badge></h5>
